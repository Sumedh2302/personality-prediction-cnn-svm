...
root.title("Personality Prediction Using Machine Learning ")
...
canvas.pack()
text_var="Personality Prediction Using Machine Learning"
...
d2=tk.Button(root,text="Login",command=Login,width=20,height=2,bd=5,background="gray",foreground="white",font=("times new roman",14,"bold"))
d2.place(x=400,y=110)


d3=tk.Button(root,text="Register",command=Register,width=20,height=2,bd=5,background="gray",foreground="white",font=("times new roman",14,"bold"))
d3.place(x=700,y=110)

d3=tk.Button(root,text="Exit",command=window,width=20,height=2,bd=5,background="gray",foreground="white",font=("times new roman",14,"bold"))
